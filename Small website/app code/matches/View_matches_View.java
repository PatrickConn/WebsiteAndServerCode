...
import poject.Pat.Main_players;
import poject.Pat.R;
...
public class View_matches_View extends ListActivity {
    ...
    class ListAllMatches extends AsyncTask<String, String, String> {
        ...
        {
            super.onPreExecute();
            CDialog = new ProgressDialog(View_matches_View.this);
        ...
        protected void onPostExecute(String file_url) 
        {
            ...
            runOnUiThread(new Runnable() 
            {
                public void run() 
                {
                    ListAdapter adapter = new SimpleAdapter(View_matches_View.this, MatchesList,R.layout.coaches_entry, new String[] {"id","home","Aresoccer","test2","Theresoccer","test","Name"}, new int[] {R.id.Id, R.id.Name,R.id.Age,R.id.test1,R.id.test2,R.id.test3,R.id.test4});
                    // updating listview
 ...
 ListView list = getListView();
        	...
        	list.setOnItemClickListener(new OnItemClickListener() 
        	{
        		...
        		public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
        		{
        			...
        			// Starting new intent
        			Intent in = new Intent(getApplicationContext(),View_matches_Info.class);

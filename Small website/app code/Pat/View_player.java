...
public class View_player extends ListActivity {
    ...
    class ListAllCoaches extends AsyncTask<String, String, String> {
        ...
        {
            super.onPreExecute();
            CDialog = new ProgressDialog(View_player.this);
        ...
        protected void onPostExecute(String file_url) 
        {
            ...
            runOnUiThread(new Runnable() 
            {
                public void run() 
                {
                    ListAdapter adapter = new SimpleAdapter(View_player.this, PlayersList,R.layout.coaches_entry, new String[] {"id","Nametext","Name","spase","Age"}, new int[] {R.id.Id, R.id.Name,R.id.Age,R.id.test1,R.id.test2});
                    // updating listview
        	...
        	list.setOnItemClickListener(new OnItemClickListener() 
        	{
        		...
        		public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
        		{
        			...
        			// Starting new intent
        			Intent in = new Intent(getApplicationContext(),View_Player_Info.class);
